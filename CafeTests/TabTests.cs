    ...
    public class TabTests : BDDTest<TabAggregate>
    {
        ...
        public void OrderedDrinksCanBeServed()
        {
            Test(
                ...
                {
                    Id = testId,
                    MenuNumbers = [testDrink1.MenuNumber, testDrink2.MenuNumber]
                }),
        ...
        public void FoodNotOrderedCanNotBeMarkedPrepared()
        {
            Test(
                ...
                {
                    Id = testId,
                    MenuNumbers = [testFood2.MenuNumber]
                }),
        ...
        public void CanServePreparedFood()
        {
            Test(
                ...
                {
                    Id = testId,
                    MenuNumbers = [testFood2.MenuNumber, testFood1.MenuNumber]
                }),
                Then(new FoodServed
                {
                    Id = testId,
