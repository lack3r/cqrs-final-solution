...
namespace CafeReadModels
{
        ...
        ISubscribeTo<TabClosed>
    {
        ...
        private readonly Dictionary<Guid, Tab> todoByTab = [];
        ...
        public TabInvoice InvoiceForTable(int table)
        {
            ...
            lock (tab.Value)
                return new TabInvoice
                {
                    ...
                    HasUnservedItems = tab.Value.InPreparation.Count != 0 || tab.Value.ToServe.Count != 0
                };
        }
